...
servicesBTN4 = tk.Button(ServicesFrame,text="Button4").pack()
servicesBTN5 = tk.Button(ServicesFrame,text="Button5").pack()
servicesBTN6 = tk.Button(ServicesFrame,text="Button6").pack()
servicesBTN7 = tk.Button(ServicesFrame,text="Button7").pack()
servicesBTN8 = tk.Button(ServicesFrame,text="Button8").pack()
